        ...
        <nav class="nav container">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                            ...
                            <div class="dropdown__content">
                                <div class="dropdown__group">
                                    ...
                                    <ul class="dropdown__list">
                                        <li>
                                            <a href="login.php" class="dropdown__link">Columa Cuadrada Rectangular</a>
                                        </li>
                                        <li>
                                            <a href="login.php" class="dropdown__link">Columna Circular</a>
                                        </li  >
                                        <li>
                                            <a href="login.php" class="dropdown__link">Columna en T</a>
                                        </li>
                                        <li>
                                            <a href="login.php" class="dropdown__link">Columna en L</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="dropdown__group">
                                    ...
                                    <ul class="dropdown__list">
                                        <li>
                                            <a href="login.php" class="dropdown__link">PLACAS EN C</a>
                                        </li>
                                        <li>
                                            <a href="login.php" class="dropdown__link">PLACAS EN L</a>
                                        </li>
                                        <li>
                                            <a href="login.php" class="dropdown__link">PLACAS EN T</a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="dropdown__container">
                            <div class="dropdown__content">
                                <div class="dropdown__group">
                                    ...
                                    <ul class="dropdown__list">
                                        <li>
                                            <a href="login.php" class="dropdown__link">Diseño de
                                                VIGAS</a>
                                        </li>
                                        <!-- <li>
                                ...
                                <div class="dropdown__group">
                                    ...
                                    <ul class="dropdown__list">
                                        <li>
                                            <a href="login.php" class="dropdown__link">Diseño de Columnas</a>
                                        </li>
                                        <!-- <li>
                                ...
                                <div class="dropdown__group">
                                    ...
                                    <ul class="dropdown__list">
                                        <li>
                                            <a href="login.php" class="dropdown__link">Diseño de Zapata
                                                Aislada</a>
                                        </li>
                                        <!-- <li>
                                            <a href="#" class="dropdown__link">Tutorial videos</a>
                    ...
                    <li>
                        <a href="login.php" class="nav__link">Iniciar Session</a>
                    </li>
