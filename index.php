<title>ADM | RIZABAL&ASOCIADOS</title>
<?php
...
<section class="home" id="home">
    ...
    <div class="content">
        ...
        <div class="btn-group">
            <a href="login.php" class="btn btn-primary blue">Registrarse</a>

            <a href="#about" class="btn">Contactenos</a>
        </div>
        <div class="socials">
...
<section class="about" id="about">
    ...
    <div class="row">
        ...
        <div class="content">
            <h3>RIZABAL & ASOCIADOS<br>Ingenieros Estructurales</h3>
